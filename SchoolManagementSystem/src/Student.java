...
// Combobox containing all the courses
    ...
    private void initComponents() {
        ...
        inputadd.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                inputaddKeyReleased(evt);
            }
        });
        ...
        searchCourse.setBackground(new java.awt.Color(204, 255, 204));
        searchCourse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchCourseActionPerformed(evt);
            }
        });
        jPanel3.add(searchCourse, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 320, 180, 30));

        course.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        course.setText("Course:");
        jPanel3.add(course, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, -1));
        ...
        jPanel3.add(submit, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 390, 90, -1));
        ...
        jPanel3.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\2ndyrGroupB\\Desktop\\JudyFinalProjectJava\\SchoolManagementSystem\\school3.png")); // NOI18N
...
//   IF MAIN MENU BUTTON WAS CLICKED IT WILL GO BACK TO THE MAIN MENU PAGE
        setVisible(false);
        Menu menu = new Menu();
        menu.setVisible(true);
    }//GEN-LAST:event_mainMenuActionPerformed
//WHEN TABLE MOUSE CLICKED
...
//TO SEARCH FROM THE TABLE
    ...
    private void inputaddKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_inputaddKeyReleased
        update.setEnabled(true);
        delete.setEnabled(false);
    }//GEN-LAST:event_inputaddKeyReleased
